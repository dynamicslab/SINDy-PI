...
function [utsol,usol,x,k]=Example_1(dt,T,L,n,PDE_Plot,Compare)
...
if Compare==0
    ...
    a1=1;
    u1=(a1*(sech(0.1*(x-20)).^2)).';
    %
    a2=1;
    u2=(a2*(sech(0.1*(x+10)).^2)).';
    %
    u=u1+u2;
end
...
[time,utsol]=ode45(@(time,u0)Ex_ODE_1(time,u0,k,x),tspan,ut,opts);
