...
function [Data,Sym_Struct]=SINDyLib_PDE_Find_mKvd(U,Ut,Utt,Ux,Uxx,Uxxx)
...
for i=2:size(Org_Data,2)
    Index=Index+1;
    Data(:,Index)=Org_Data(:,1).^2.*Org_Data(:,i).^2;
    Sym_Struct{1,Index}=Org_Sym(1,1)^2*Org_Sym(1,i).^2;
end
